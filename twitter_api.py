...
class TwitterAPI:
    ...
    def search_tweet_by_keyword(self, keyword):
        """
        ...
        tweets = self.client.search_recent_tweets(query=keyword, tweet_fields=['context_annotations', 'created_at', 'public_metrics'])
...
if __name__ == '__main__':
    ...
    result = twitter_api.search_tweet_by_keyword('Alex')
    print(result)
